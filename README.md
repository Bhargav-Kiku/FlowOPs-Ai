...
FlowOps AI Backend (this service)
        ...
        ▼
Groq LLM API (qwen/qwen3.6-27b / qwen/qwen3.6-27b)
```
...
| `GROQ_MODEL` | ❌ | `qwen/qwen3.6-27b` | Primary LLM model |
| `GROQ_FAST_MODEL` | ❌ | `qwen/qwen3.6-27b` | Fast model for `/summary` |
...
```json
{
  ...
  "_meta": { "model": "qwen/qwen3.6-27b", "retried": false, "requestId": "..." }
}
```
...
Generates a concise 2-4 sentence summary of any hotel operations context. Uses the fast model (`qwen/qwen3.6-27b`) for low latency.
...
```json
{
  ...
  "ai_role": "recommendation_only",
  "_meta": { "model": "qwen/qwen3.6-27b", "retried": false }
}
```
